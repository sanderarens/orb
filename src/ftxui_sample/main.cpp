...
// configuration step. It creates a namespace called `orb`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", orb::cmake::project_name, orb::cmake::project_version) };
